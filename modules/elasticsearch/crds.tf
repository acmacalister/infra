// download from here: https://download.elastic.co/downloads/eck/1.9.1/crds.yaml
// converted with cat crds.yaml | tfk8s --strip | pbcopy
// brew install tfk8s
// this will install the custom resource definitions needed by the operator
